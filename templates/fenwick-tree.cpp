class FenwickTree
{
  // range queries and updates (binary, identity, inverse): https://cp-algorithms.com/data_structures/fenwick.html
  // Don’t forget to build the tree with updates, not with assignments
